...
//       return $el.append('<h3>' + data.name + '</h3>' + '<ul class="player__card__list"><li><span>Games</span><br/>' + data.games + '</li><li><span>DOB</span><br/>' + data.dob + ' yr</li><li><span>Position</span><br/>' + data.pos + '</li><li><span>Origin</span><br/>' + data.origin + '</li></ul>' + '<ul class="player__card__list player__card__list--last"><li><span>Games</span><br/>' + data.games + '</li><li><span>Goals</span><br/>' + data.goals + '</li></ul>');
//     },
